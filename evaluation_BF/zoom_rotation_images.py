...
path = 'E:\\VNUKUniversity\\ThirdYear\\Internship\\FeatureExercises\\img\\wall\\'
...
def plot_recall():
    ...
    plt.suptitle('Recall Plotting in Zoom + Rotation images')
...
def plot_precision():
    ...
    plt.suptitle('Precision Plotting in Zoom + Rotation images')
...
def plot_precision_1():
    ...
    plt.subplot(133)
    plt.plot(names, values)
    plt.suptitle('1 - Precision Plotting in Zoom + Rotation images')
